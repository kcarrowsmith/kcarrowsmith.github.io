...
![*Each line represents the temperature on a single day in 2021. The highlighted line shows the temperature for a single day---July 17, 2021.*](kp-07172021.png){width=50%}
...
![*Temperatures at which I observed plant-pollinator interactions across my study.*](heatmap_bloom.png){width=100%}
